...
<meta charset="ISO-8859-1">
 <link rel="stylesheet" href="mainpagestyles.css">
  <link rel="stylesheet" href="contactusstyless.css">
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title>Main Page</title>
</head>
<body background="C:\Users\sine3351\Pictures\vote1.jpg">
	<section class="Main">
	<div class="menu">
           <div class="logo"> <img src="C:\Users\sine3351\Pictures\votelogo.jpg" alt="logo">
                <h3 style="text-align:left;">E-VOTING</h3>
            </div>
            <div class="nav" >
            <a  class="active" href="#"><i class="fa fa-home"></i>Home</a>
            <a href="residentvoter.jsp"><i class="fa fa-vcard"></i>Resident Voter</a>
            <a href="nri_residentvoter.jsp"><i class="fa fa-vcard"></i>Non-Resident Voter</a>
            <a href="adminlogin.jsp"><i class="fa fa-user"></i>Admin</a>
            <a href="aboutus.jsp"><i class="fa fa-group"></i>About Us</a> 
        </div>  
    </div><br><br>
    <div class="heading">
