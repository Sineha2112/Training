...
<body>
    ...
    <a href="voterregister.jsp" class="signUpLink">Create an account</a>
    </div>
    
    <div class="signin-form">
    <h2 class="form-title">Sign In</h2>
    
    <form name="Login"  action="/loginVoter" class="loginForm" method="post">
       ...
       <label for="password"></label><br>
        ...
        <div class="form-submit"><button type="submit">SignIn</button>&emsp;
       <button type="reset">Cancel</button><br></div><br>
