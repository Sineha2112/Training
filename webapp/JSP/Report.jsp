...
<body>
<div class="voter">
	<h1>Report Candidate</h1>
	<form name="report" action="/report" method="post">
	<div class="feed">
	<label for="id"><b>Enter User Id:</b></label><br>
    <input type="text" name="id" placeholder="User Id" required id="id"><br><br>
    
    <label for="partyName"><b>Enter FeedBack:</b></label><br>
    <input type="text" name="partyName" placeholder="Party Name" id="partyName"><br><br>
              
    <label for="complaints"><b>Enter FeedBack:</b></label><br>
    <input type="text" name="complaints" placeholder="Complaints" id="complaints"><br><br>
